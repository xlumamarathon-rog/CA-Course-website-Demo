...
const doc = (data) => ({ __v: DB_VERSION, updatedAt: new Date().toISOString(), data });
...
export const SEEDS = [
  ...
  },
  {
    ...
    build: () => doc({
      ...
      courses: seedCourses(),
      site: DEFAULT_SITE,
      user: { name: 'Priya Sharma', email: 'learner@thinkingbridge.in', role: 'user' },
      purchases: { 'learner@thinkingbridge.in': ['audit', 'placement'] },
  ...
  },
  {
    ...
    build: () => {
      ...
      return doc({
        ...
        courses,
        site: DEFAULT_SITE,
        user: { name: 'Archit Agarwal', email: 'admin@thinkingbridge.in', role: 'admin' },
        purchases: { 'admin@thinkingbridge.in': [] },
        progress: {}, notes: {}
      });
    }
  },
  {
    ...
    build: () => doc({
      ...
      user: { name: 'Archit Agarwal', email: 'admin@thinkingbridge.in', role: 'admin' },
      purchases: {
        'learner@thinkingbridge.in': ['audit', 'excel', 'placement'],
        'student@thinkingbridge.in': ['tax', 'placement'],
        'admin@thinkingbridge.in': []
      },
      progress: {
  ...
  },
  {
    ...
    build: () => doc({
      ...
      site: DEFAULT_SITE,
      user: { name: 'Priya Sharma', email: 'learner@thinkingbridge.in', role: 'user' },
      purchases: { 'learner@thinkingbridge.in': ['audit'] },
